...
public class StoryDetailFragment extends Fragment {
    ...
    /**
     * The dummy author this fragment is presenting.
     */
    private DummyContent.Story mItem;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            // Load the dummy author specified by the fragment
            // arguments. In a real-world scenario, use a Loader
            // to load author from a author provider.
            mItem = DummyContent.ITEM_MAP.get(getArguments().getString(ARG_ITEM_ID));

            Activity activity = this.getActivity();
            CollapsingToolbarLayout appBarLayout = (CollapsingToolbarLayout) activity.findViewById(R.id.toolbar_layout);
            if (appBarLayout != null) {
                appBarLayout.setTitle(mItem.author);
            }
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Show the dummy author as text in a TextView.
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.story_detail)).setText(mItem.points);
        }
